...
world={
    "items":{},
    "persons":{"P ":[Person(100,[],{"min_damage":1,"max_damage":6,"armor":2,"speed":1},[0,1],"P "),"Player"]},
    ...
    "area":[[". ","P ",". ",". ",". ",". ",],
        ...
        [". ",". ",". ",". ",". ",". ",],
        [". ",". ",". ",". ",". ",". ",]],}
i=spawn_npc(True, world["persons"]["P "][0],5,[],{"min_damage":1,"max_damage":4,"armor":1.5,"speed":1},[2,1],"M ",world,{100:[]},"Ork")
if i:
...
while True:
    ...
    for i in list(world["persons"]):
        if i!="P ":
            t=world["persons"][i][0].act(world,world["persons"][i][0].movement(world["letter"],world["area"],world["direc"]))
